...
# density_profile.tcl --
#
# UI generated by GUI Builder Build 146 on 2012-11-23 18:32:06 from:
...
set density_profile::SCRIPTDIR [file dirname [info script]]
source [file join $density_profile::SCRIPTDIR density_profile_ui.tcl]
...
# VMD-specific stuff
set density_profile::in_vmd [string length [info proc vmd_install_extension]]
if { $density_profile::in_vmd } {
    vmd_install_extension density_profile density_profile::density_profile_tk "Analysis/Density Profile Tool"
}

# Called right upon menu action
proc density_profile::density_profile_tk {} {
#    puts "In density_profile_tk"
	...
	density_profile::ui $density_profile_window; # density_profile::init is now obsolete
    }
...
proc density_profile::get_ylabel {} {
    variable target
...
proc density_profile::do_plot_all arr {
    variable resolution
...
# proc density_profile::plot_all arr {
#     variable resolution
#     variable area
#     upvar $arr inp
...
# density_profile::_checkbutton_1_command --
#
...
#    <NONE>
#
proc density_profile::_checkbutton_1_command args {}

# density_profile::_checkbutton_2_command --
#
...
#    <NONE>
#
proc density_profile::_checkbutton_2_command args {}

# density_profile::_entry_1_invalidcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_1_invalidcommand args {}

# density_profile::_entry_1_validatecommand --
#
...
#    <NONE>
#
proc density_profile::_entry_1_validatecommand args {}

# density_profile::_entry_1_xscrollcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_1_xscrollcommand args {}

# density_profile::_entry_2_invalidcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_2_invalidcommand args {}

# density_profile::_entry_2_validatecommand --
#
...
#    <NONE>
#
proc density_profile::_entry_2_validatecommand args {}

# density_profile::_entry_2_xscrollcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_2_xscrollcommand args {}

# density_profile::_entry_3_invalidcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_3_invalidcommand args {}

# density_profile::_entry_3_validatecommand --
#
...
#    <NONE>
#
proc density_profile::_entry_3_validatecommand args {}

# density_profile::_entry_3_xscrollcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_3_xscrollcommand args {}

# density_profile::_entry_4_invalidcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_4_invalidcommand args {}

# density_profile::_entry_4_validatecommand --
#
...
#    <NONE>
#
proc density_profile::_entry_4_validatecommand args {}

# density_profile::_entry_4_xscrollcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_4_xscrollcommand args {}

# density_profile::_entry_5_invalidcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_5_invalidcommand args {}

# density_profile::_entry_5_validatecommand --
#
...
#    <NONE>
#
proc density_profile::_entry_5_validatecommand args {}

# density_profile::_entry_5_xscrollcommand --
#
...
#    <NONE>
#
proc density_profile::_entry_5_xscrollcommand args {}

# density_profile::_radiobutton_1_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_1_command args {}

# density_profile::_radiobutton_2_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_2_command args {}

# density_profile::_radiobutton_3_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_3_command args {}

# density_profile::_radiobutton_4_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_4_command args {}

# density_profile::_radiobutton_5_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_5_command args {}

# density_profile::_radiobutton_6_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_6_command args {}

# density_profile::_radiobutton_7_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_7_command args {}

# density_profile::_radiobutton_9_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_9_command args {}

# density_profile::_radiobutton_10_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_10_command args {}

# density_profile::_radiobutton_11_command --
#
...
#    <NONE>
#
proc density_profile::_radiobutton_11_command args {}

# density_profile::close_command --
#
...
#    <NONE>
#
proc density_profile::close_command args {}

# density_profile::plot_command --
#
...
#    <NONE>
#
proc density_profile::plot_command args {
    do_plot
}

# END CALLBACK CODE

# density_profile::init --
#
...
#
proc density_profile::init {root args} {
    # Catch this in case the user didn't define it
    catch {density_profile::userinit}
    if {[info exists embed_args]} {
	# we are running in the plugin
	density_profile::ui $root
    } elseif {$::argv0 == [info script]} {
	# we are running in stand-alone mode
	wm title $root density_profile
	if {[catch {
	    # Create the UI
	    density_profile::ui  $root
	} err]} {
    ...
    catch {density_profile::run $root}
}
density_profile::init .
